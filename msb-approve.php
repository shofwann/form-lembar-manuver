        ...
        <div class="card-body">
            ...
            <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-2">
                            <label for="">User MSB</label>
                            <input type="text" name="userMsb" value="<?= $_SESSION['username'];?>" class="form-control" readonly>
                        </div>
                        <div class="col-2">
                            <label for="">Time MSB Aprove</label>
                        ...
                        <div class="col-2">
                            ...
                            <input type="text" name="statusAE" value="<?= $data["ae"]; ?>" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col"></div>
                        ...
                        <div class="col-3" style="border:1px solid #B2BABB; ">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <?php while ($manuverBebas = mysqli_fetch_array($sql_manuver)) { ?>
                                                <tr>
                                                    <td style="height:48px"><?= $manuverBebas["spv_gitet_normal"]  ?></td>
                                                    <td><?= $manuverBebas["opr_gitet_normal"]  ?></td>
                                                </tr>
                                            <?php } ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col" style="border:1px solid;padding-top:.50rem;padding-bottom:.50rem">
                            <textarea name="catatan_msb" id="" cols="113" rows="5" style="border:1px solid #fff;"><?= $data["catatan_msb"];?></textarea>
                        </div>
                    </div>
