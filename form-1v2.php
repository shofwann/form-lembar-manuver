      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="form-1v2.php">Form-1</a>
                    ...
                    <!-- Baris/ row ke-4-->
                        <div class="row"> 
                            <div class="form-group col-2 ml-2">
                                ...
                                <input type="file" name="foto" class="form-control" accept=".jpg, .png"><font color="red">*tipe yang bisa diinput:.jpg dan .png</font>
                            </div>
                        </div>
