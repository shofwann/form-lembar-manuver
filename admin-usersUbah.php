        ...
        <form action="" method="post" enctype="multipart/form-data">
            <table>
                ...
                <tr>
                    ...
                    <td colspan="3" ><button type="submit" name="submit">Ubah</button><a href="admin-dashboard.php?url=users" class=""><input type="button" value="batal"></a></td>
            ...
            <?php if(mysqli_num_rows($sql) > 0) { ?>
                <?php while($data = mysqli_fetch_assoc($sql)) { ?>
                    <tr>
                        ...
                        <td><a href="?url=hapus&id=<?= $data["id"]; ?>"><i class="fas fa-trash-alt"></a></td>
                    </tr>
                    <?php $no++; ?>
                <?php } ?>
            <?php } ?>
