...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gray-900 sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="plh-msb-dashboard.php">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="plh-msb-dashboard.php">
      ...
      <li class="nav-item">
        <a class="nav-link" href="?url=amnInbox">
          ...
          <span>Inbox</span></a>
            ...
            <!-- Nav Item - aproval-msb -->
     <li class="nav-item">
        <a class="nav-link" href="?url=msbInbox">
          <i class="fas fa-check-square"></i> 
          <span>Aproval MSB</span></a>
      </li>
