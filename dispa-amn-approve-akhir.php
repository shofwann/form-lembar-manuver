            ...
            <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <!-- Baris/row Ke-0-->
                            ...
                            <div class="row">
                                ...
                                <div class="col" style="border:1px solid;padding-top:.50rem;padding-bottom:.50rem">
                                    <input type="text" style="border:1px solid #fff;" value="<?= $data["dpf_akhir"]; ?>" disabled>
                                    <?= ($data['foto_dpf2'] == null) ? 'belum upload foto DPF' : '<a href="dpf/' . $data['foto_dpf2'] . '" class="btn" download><span class="text fas fa-download"></span></a>'; ?>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col" style="border:1px solid;padding-top:.50rem;padding-bottom:.50rem">
                                    <input type="text" style="border:1px solid #fff" value="<?= $data["scada_akhir_after"]; ?>" disabled>
                                </div>
                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered mt-2" id="dynamic_field1" style="">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= date("H:i T", strtotime($pembebasan["ads"]));  ?></td>
                                            ...
                                            <table class="table table-bordered mt-2" id="dynamic_field2" style="">
                                                ...
                                                <?php while ($penormalan = mysqli_fetch_assoc($tahapan_pemnormalan) ) : ?>
                                                    <tr>
                                                        ...
                                                        <td><?= date("H:i T", strtotime($penormalan["remote"]));  ?></td>
                                                        <td><?= date("H:i T", strtotime($penormalan["real_"]));  ?></td>
                                                        <td><?= date("H:i T", strtotime($penormalan["ads"]));  ?></td>
                            ...
                            <div class="row">
                                <div class="col" style="border:1px solid;padding-top:.50rem;padding-bottom:.50rem">
                                    <textarea name="catatan_pasca_normal" id="" cols="232" rows="3" style="border:1px solid #fff;" disabled><?= $data["catatan_pasca_penormalan"]; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col" style="border:1px solid;padding-top:.50rem;padding-bottom:.50rem">
                                    <textarea name="catatan_amndis_akhir" id="" cols="113" rows="5" style="border:1px solid #fff;"><?= $data["catatan_amnDispa_akhir"]; ?></textarea>
                                </div>
                            </div>
